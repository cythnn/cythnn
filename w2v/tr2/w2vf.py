from tools.hs.hs import createHS
...
from w2v.tr2.train import trainPtr
from w2v.train.stream import stream
import numpy

from w2v.train.train import tr
...
if __name__ == "__main__":
    ...
    print(len(wordstreams), wordstreams[0])
    hs = createHS( vocab )
    hs.stream( model, wordstreams, trainPtr())
